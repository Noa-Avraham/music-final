...
import SongsLandingPageStyle from "../songsLandingPage/SongsLandingPage.style";
...
export default function EditSong(props: any) {
    ...
    let songToEdit: SongModel = {...props.songs[0] };
                ...
                <Container component="main" maxWidth="xs">
                    ...
                    <Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center', }}>
                        <Box component="form" noValidate sx={{ mt: 1 }}>
                            ...
                            {keys.map((key) => {
                                return <>
                                    <TextField key={n++} color="secondary" name={`${key}Name`} defaultValue={songToEdit[key as keyof typeof songToEdit]} id="outlined-basic" label={key} variant="outlined" margin="dense" onChange={(e) => { songToEdit = { ...songToEdit, [key]: e.target.value } }} />
                                    <br />
                                </>
                            })}
